...
class HelloGltfDemo : DemoScene("Hello glTF") {
    override fun Scene.setupMainScene(ctx: KoolContext) {
        ...
        lighting.singleSpotLight {
            setup(Vec3f(5f, 6.5f, 7.5f), Vec3f(-1f, -1.25f, -1.5f), 45f)
            setColor(Color.WHITE, 300f)
        }
        //val shadowMap = SimpleShadowMap(this, lighting.lights[0]) // More recent version of SimpleShadowMap will work with class Light
        val shadowMap = SimpleShadowMap(this, 0)
