package de.fabmax.kool.demos.demos.physics.island.environment

import de.fabmax.kool.demos.demos.physics.island.shader.TreeShader
...
class Trees(val terrain: Terrain, nTrees: Int, val wind: Wind, val sky: Sky) {
    ...
    init {
        ...
        for (i in 0 until 20) {
            ...
            val treeData =
                IndexedVertexList(Attribute.POSITIONS, Attribute.NORMALS, Attribute.COLORS, Wind.WIND_SENSITIVITY)
