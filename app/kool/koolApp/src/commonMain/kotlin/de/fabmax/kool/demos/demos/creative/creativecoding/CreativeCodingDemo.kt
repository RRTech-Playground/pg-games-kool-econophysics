package de.fabmax.kool.demos.demos.creative.creativecoding

import de.fabmax.kool.Assets
import de.fabmax.kool.KoolContext
import de.fabmax.kool.demos.DemoLoader
import de.fabmax.kool.demos.demos.DemoScene
import de.fabmax.kool.demos.demos.creative.creativecoding.content.*
        ...
        MenuRow {
            ...
            ComboBox {
                modifier
                    ...
                    .onItemSelected {
                        selectContent(it)
                        // somewhat ugly: make sure the remembered() settings values are reset when switching between scenes
