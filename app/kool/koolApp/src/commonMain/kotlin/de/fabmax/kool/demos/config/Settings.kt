package de.fabmax.kool.demos.config
...
/**
 * Object containing all demo related global setting
 */
object Settings {
    ...
    //val defaultUiSize = defaultUiSizes["Large"]  // interesting, returns defaultUiSizes? while the above returns defaultUiSizes
    ...
    val showDebugOverlay = MutableStateSettings("koolDemo.showDebugOverlay", false) { it.toBoolean() }
    val showMenuOnStartup = MutableStateSettings("koolDemo.showMenuOnStartup", false) { it.toBoolean() }
